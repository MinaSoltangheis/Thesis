...
def writeFiles(summary, keyphrases, fileName):
    ...
    keyphraseFile = open('OnlyKeywords/' + fileName, 'w')
    for keyphrase in keyphrases:
        keyphraseFile.write(keyphrase + '\n')
    keyphraseFile.close()

    print "Generating output to " + 'summaries/' + fileName
    summaryFile = open('OnlySummaries/' + fileName, 'w')
...
articles = os.listdir("SkillsOnlyArticles")
for article in articles:
    print 'Reading articles/' + article
    articleFile = open('SkillsOnlyArticles/' + article, 'r')
